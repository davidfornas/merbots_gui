...
#ifndef UI_SET_PARAMS_H
#define UI_SET_PARAMS_H
...
public:
    ...
    void setupUi(QDialog *SetParamsDlg)
    {
    ...
    void retranslateUi(QDialog *SetParamsDlg)
    {
...
namespace Ui {
    class SetParamsDlg: public Ui_set_params {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_SET_PARAMS_H
