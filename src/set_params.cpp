...
#include "ui_set_params.h"

#include <ros/package.h>

SetParamsDlg::SetParamsDlg(ros::NodeHandle *nodeHdl, QWidget *parent) :
    QDialog(parent),
    ui(new Ui::SetParamsDlg),
    _nh(nodeHdl)
{
    ui->setupUi(this);
...
SetParamsDlg::~SetParamsDlg()
{
    delete ui;
}


void SetParamsDlg::getMarkerPoseButtonClicked()
{
...
void SetParamsDlg::acceptButtonClicked()
{
